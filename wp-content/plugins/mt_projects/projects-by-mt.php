...
'http://modernthemes.net/updates/?action=get_metadata&slug=mt_projects', //Metadata URL.
__FILE__, //Full path to the main plugin file. 
'mt_projects' //Plugin slug 
);
...
function mt_projects_add_scripts() {
	global $mt_projects_directory, $mt_projects_path; 
		...
		wp_enqueue_style('mt-projects-luna-css', $mt_projects_directory.'css/mt-projects-luna.css'); 
		wp_enqueue_style('mt-projects-venture-css', $mt_projects_directory.'css/mt-projects-venture.css');  
